...
NGINX_EXTRA_CONF="assets.conf error_page.conf extra_protect.conf maintenance.conf php_backend.conf maps.conf phpmyadmin.conf varnish_proxy.conf setup.conf pagespeed.conf status.conf"
